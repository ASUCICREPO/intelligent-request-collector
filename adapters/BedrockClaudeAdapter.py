...
class BedrockClaudeAdapter():
    ...
    def generate_llm_payload(self, system_prompt, messages , max_tokens=512, temperature=0.5):
        payload = {
    ...
    def get_llm_body(self, chat_history, max_tokens=512, temperature=0.5):
        system_prompt = """
